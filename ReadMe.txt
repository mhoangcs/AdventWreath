...
TERMS OF USE: 
* Noncommercial use only.  You may use AdventWreath on your personal or church website, but it may not be displayed on or packaged with any site/code/material that is used for commercial purposes.
* No derivative works.  Feel free, however, to suggest modifications or submit a pull request if you find a bug.  :)
* No redistribution.
* Attribution is appreciated, but not required.
---------------------

DESCRIPTION: AdventWreath is a simple and easy-to-use script that displays a festive wreath on your website, blog, or any online space where you want to observe the season of Advent.  This wreath includes five candles: 
...
3.  Use this image tag as a placeholder for the wreath - the width and style are optional, but the class "adventWreath" is required:
...
2.  Open the adventWreath.js in a text editor, like Notepad.  Replace the image URLs with the direct links to your hosted images:
...
3.  Right before the closing </body> tag of your blog, paste the entire contents of adventWreath.js, surrounding it with <script></script> tags.
3.  Use this image tag as a placeholder for the wreath - the width and style are optional, but the class "adventWreath" is required:
<img class="adventWreath" width="200px" style="display: block; margin: 0 auto;" />